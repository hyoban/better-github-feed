  ...
  return (
    <button
      ...
      className={cn(
        ...
        'group-data-[collapsible=offExamples]:translate-x-0 group-data-[collapsible=offExamples]:after:start-full hover:group-data-[collapsible=offExamples]:bg-sidebar rtl:group-data-[collapsible=offExamples]:-translate-x-0',
