  ...
  primitives: {
    select: ({ className, ...props }) => {
      return (
        <select
          className={cn(
            'h-10 min-w-25 rounded-md border border-input bg-background px-3 py-1.5 shadow-xs outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50',
            className,
          )}
          {...props}
        />
